  ...
  const mutations=[
    ...
    db=>db.execute({
      sql:`INSERT INTO schema_migrations
        (version,name,checksum,execution_ms,disposition) VALUES (13,'future',?,0,'applied')`,
      args:['f'.repeat(64)],
    }),
  ];
