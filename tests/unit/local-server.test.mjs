...
test('database preparation migrates before serving and rejects unmanaged state',async()=>{
  ...
  assert.deepEqual(
    ...
    [[1,'applied'],[2,'applied'],[3,'applied'],[4,'applied'],[5,'applied'],[6,'applied'],[7,'applied'],[8,'applied'],[9,'applied'],[10,'applied'],[11,'applied'],[12,'applied'],[13,'applied'],[14,'applied'],[15,'applied'],[16,'applied'],[17,'applied'],[18,'applied']],
  );
  await db.close();
  cleanup.pop();
